...
//
//import com.springcloud.security.UserDetailsServiceImpl;
...
//                .mvcMatchers("/", "/login", "/showReg", "/registerUser").permitAll().anyRequest().denyAll().and().csrf().disable().logout().logoutSuccessUrl("/");
//    }
//
//    @Bean
